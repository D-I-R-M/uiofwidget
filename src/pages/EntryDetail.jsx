...
export default function EntryDetail() {
  ...
  const actLabel = entry.activity ? entry.activity.split('.').pop() : 'Unknown'
        ...
        <aside className={styles.aside}>
          <div className={styles.metaCard}>
            ...
            <dl className={styles.metaList}>
              <dt>UID</dt>
              <dd className={styles.mono}>{entry.uid}</dd>
              <dt>Activity</dt>
              <dd className={styles.mono}>{entry.activity || 'Unknown'}</dd>
              <dt>MIME type</dt>
              <dd className={styles.mono}>{entry.mime_type || 'Unknown'}</dd>
              <dt>File size</dt>
              <dd>{formatBytes(entry.filesize)}</dd>
              <dt>Sharing</dt>
              <dd>{entry.share_scope || 'private'}</dd>
            </dl>
          </div>
          ...
          <div className={styles.reflectCard}>
            ...
            <button
              ...
              disabled={reflecting}
            >
              {reflecting ? 'Reflecting...' : 'Reflect on this entry'}
            </button>

            {reflectErr && (
              <p className={styles.reflectError}>Error: {reflectErr}</p>
            )}
